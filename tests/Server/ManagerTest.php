...
namespace Ofcold\HttpSwoole\Tests\Server;
...
use Ofcold\HttpSwoole\Websocket\HandShakeHandler;
use Ofcold\HttpSwoole\Websocket\Parser;
use Ofcold\HttpSwoole\Server\PidManager;
...
use Ofcold\HttpSwoole\Websocket\Rooms\TableRoom;
use Ofcold\HttpSwoole\Websocket\Rooms\RoomContract;
use Illuminate\Contracts\Debug\ExceptionHandler;
use Ofcold\HttpSwoole\Websocket\SocketIO\SocketIOParser;
use Ofcold\HttpSwoole\Websocket\SocketIO\WebsocketHandler;
use Illuminate\Contracts\Config\Repository as ConfigContract;
use Ofcold\HttpSwoole\Websocket\Facades\Websocket as WebsocketFacade;
...
class ManagerTest extends TestCase
{
	...
	{
		parent::mockMethod($name, $function, 'Ofcold\HttpSwoole\Server');
	}
}
