...
return [
	...
	*/
	'resetters' => [
		Ofcold\HttpSwoole\Server\Resetters\ResetConfig::class,
		Ofcold\HttpSwoole\Server\Resetters\ResetSession::class,
		Ofcold\HttpSwoole\Server\Resetters\ResetCookie::class,
		Ofcold\HttpSwoole\Server\Resetters\ClearInstances::class,
		Ofcold\HttpSwoole\Server\Resetters\BindRequest::class,
		Ofcold\HttpSwoole\Server\Resetters\RebindKernelContainer::class,
		Ofcold\HttpSwoole\Server\Resetters\RebindRouterContainer::class,
		Ofcold\HttpSwoole\Server\Resetters\RebindViewContainer::class,
		Ofcold\HttpSwoole\Server\Resetters\ResetProviders::class,
	],
