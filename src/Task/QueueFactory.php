...
namespace Ofcold\HttpSwoole\Task;

use Illuminate\Support\Arr;
use Ofcold\HttpSwoole\Helpers\FW;
use Ofcold\HttpSwoole\Task\SwooleTaskQueue;
...
class QueueFactory
{
	 ...
	 * @const string
	 */
	public const QUEUE_CLASS = 'Ofcold\HttpSwoole\Task\SwooleTaskQueue';
	 ...
	 *
	 * @return \Ofcold\HttpSwoole\Task\SwooleTaskQueue
	 */
